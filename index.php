...
<div class="txtdiv" style="left: 580px; top: 640px; width: 395px; height: 30px; text-align: right;">Project initiated/maintained by:</div>
<div class="imgdiv" style="left: 983px; top: 638px; width: 169px; height: 28px; background-image: url(logo2.png);"></div>
<div style="left: 690px; top: 56px; width: 590px; height: 110px; background-color: #ffffff;">
  <div class="txtdiv" style="left: 10px; top: 4px; width: 500px; height: 30px; color: #000000;">This testsuite is supported and hosted by:</div>
  <div class="txtdiv" style="left: 10px; top: 40px; width: 500px; height: 44px; color: #000000; font-size: 36px; line-height: 40px;">ARD Play-Out-Center</div>
</div>
