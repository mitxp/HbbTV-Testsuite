...
$url = 'http://'.$_SERVER['SERVER_NAME'].dirname($_SERVER['PHP_SELF']).'/stream.php/doorbell.aac';
...
function runStep(name) {
  if (name=='play') {
    ...
    try {
      ...
      showStatus(true, 'Playback started, check audio (door bell sound should be played 2 times).');
    } catch (e) {
